...
public class ArrayOfIndicatorValueExtension extends IndicatorValue {
    ...
    public static List<statistics.model.indicator.IndicatorValue> toIndicatorValueList(ArrayOfIndicatorValue value) {

        List<statistics.model.indicator.IndicatorValue> lst = new ArrayList<statistics.model.indicator.IndicatorValue>();
        for (IndicatorValue indicatorValue : value.getIndicatorValue()) {
            lst.add(IndicatorValueExtension.toIndicatorValue(indicatorValue));
        }
